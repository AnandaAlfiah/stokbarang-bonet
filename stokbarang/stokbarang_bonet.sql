...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2024 at 07:26 AM
...
--
-- Dumping data for table `tb_pengeluaran_barang`
--

INSERT INTO `tb_pengeluaran_barang` (`Tanggal_Pengeluaran`, `ID_Barang`, `Nama_Barang`, `Tipe`, `Satuan`, `Stok`, `Perangkat`) VALUES
('2024-08-09', 3, 'Batako', 'Semen', 'Barang', 20, 'Pendukung');
