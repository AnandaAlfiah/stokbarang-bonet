...
<div class="container mt-5">
    <h2>Daftar Pemasukan Barang - Admin View</h2>
    <div class="actions mb-3">
        <a href="create-pemasukan.php" class="btn btn-success"><i class="fas fa-plus"></i> Tambah Data</a>
        <form method="GET" action="pemasukan-admin.php" class="d-inline">
    ...
    <form class="d-flex mb-3" method="GET" action="pemasukan-admin.php">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            ?>
                ...
                <td>
                    <a href="edit-pemasukan.php?id=<?= $row['ID_Barang'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                    <a href="delete-pemasukan.php?id=<?= $row['ID_Barang'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fas fa-trash-alt"></i></a>
                </td>
            </tr>
            <?php endwhile; ?>
        </tbody>
        ...
        <ul class="pagination">
            ...
            for ($i = 1; $i <= $total_pages; $i++): ?>
                <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                    <a class="page-link" href="pemasukan-admin.php?page=<?= $i ?>&limit=<?= $limit ?>&search=<?= htmlspecialchars($search) ?>"><?= $i ?></a>
                </li>
            <?php endfor; ?>
        </ul>
    </nav>
